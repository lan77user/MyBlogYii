...
<div id="main" role="main" class="cf">
    <div style="margin-left: 30px; margin-top: 15px;">
        ...
        ?>
        <?php echo $form->field($SigninModel, 'user_name'); ?>
        <?php echo $form->field($SigninModel, 'password'); ?>
<?php echo Html::submitButton('登录', ['class' => 'nav-previous']) ?>

<?= Html::a('忘记密码', ['/user/forgetpwd'], ['class' => 'nav-previous']) ?>
